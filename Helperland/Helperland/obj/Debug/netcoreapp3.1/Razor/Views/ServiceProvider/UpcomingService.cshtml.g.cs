#pragma checksum "F:\Helperland\Helperland\Views\ServiceProvider\UpcomingService.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1f32d3421fafe46b921a8593291fec1ce64501be"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1f32d3421fafe46b921a8593291fec1ce64501be", @"/Views/ServiceProvider/UpcomingService.cshtml")]
...
");
                ...
                WriteLiteral(@"        var serviceDate = new Date(row.serviceStartDate);
                            ...
                            if (serviceDate < currentDate) {
                                htmlContent = ""<button class='btn rounded-pill btn-general fs-14 p-1 pe-2 ps-2 me-1 mb-1' onclick='CompeleteServiceRequest("" + row.serviceRequestId + "")' >Compelete</button>"";
                            }

                            htmlContent = htmlContent + ""<button class='btn btn-danger rounded-pill fs-14 p-1 pe-2 ps-2' onclick='CancelServiceRequest("" + row.serviceRequestId + "")' >Cancel</button>"";
      ...
      ");
                WriteLiteral(@"                      ServiceTime(resp.data.serviceStartDate, resp.data.serviceHours) + ""</b>"");
                        ...
                        $(""#lb");
                WriteLiteral(@"lSpComments"").text(resp.data.comments);
                        ...
                        divBottomBtnHtmlContent = divBottomBtnHtmlContent + ""<button class='cancel-btn fs-16 me-2 p-3 pt-2 pb-2' "" +
                            "" onclick='CancelServiceRequest("" + resp.data.serviceRequestId + "")' > <img src='../images/close-icon-small.png' class='me-1' /> Cancel<");
                WriteLiteral(@"/button>"";
 ...
 ");
        ...
        function CompeleteServiceRequest(serviceReque");
                WriteLiteral(@"stId) {
            $('#preloader').removeClass(""d-none"");
        ...
        function CancelServiceRequest(serviceRequestId) {
            ...
            $.ajax({
                ...
                data: { ""serviceRequestId"": serviceRequestId },
                s");
                WriteLiteral(@"uccess: function (resp) {
